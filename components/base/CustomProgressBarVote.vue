...
.progress-bar {
  @apply
  bg-gray-yuz w-11/12 lg:w-full h-3 rounded-lg
...
.progress-bar-detay {
  @apply
  flex px-[10%] gap-[9%] lg:gap-[9%] 2xl:gap-[10%]
}
